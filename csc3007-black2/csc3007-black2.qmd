...
:::
::: {.column width="40%"}
The ‘elbow criterion’ suggests k = 2 or 3.
...
::: {.column width="25%"}
<small>
<span style="color:#f8766d">1. High earnings and High Achievement of Legal Frameworks on Gender Equality</span>
<br />
<br />
<span style="color:#00bfc4">2. High Achievement of Legal Frameworks on Gender Equality and Low Women in Managerial Positions</span>
<br />
<br />
<span style="color:#56B4E9">3. High Percentage of Women in Managerial Positions</span>
</small>
:::
::::
...
Ten-fold cross validation indicates that the decision tree has a accuracy of `r model$results$Accuracy`. \
Kappa Value is shown to be 0, entailing data imbalance.
