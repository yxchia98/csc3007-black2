...
plot <- ggpairs(
  ...
  diag = list(continuous = wrap(
    "barDiag", bins = 10, color = "black", alpha = 1
  )),
  lower = list(
    continuous = wrap(
      "points",
...
## Anticipation of what having Fair Employment Frameworks does to Female Unemployment
...
## Fair Employment Frameworks vs Female Unemployment Rates
...
## Fair Employment Frameworks vs Female Unemployment Rates Re-Expressed
