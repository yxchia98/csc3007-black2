...
<small>Women participation in the economy is related to Goals 5 and 8.</small>
...
:::
::: {.column width="25%"}
<span style="color:#f8766d">1. Low earnings and High Gender Equality Framework</span>
<br />
<span style="color:#00bfc4">2. High Earnings</span>
:::
::::
## Decision Tree (Classificiation) {data-transitions="slide-in"}
:::: {.columns}
